...
CMD_HELP.update(
    {
        ...
        \n\n📌** CMD ➥** `.purgefrom` reply\
        \n**USAGE   ➥  **__Will Mark that message as oldest message of interval to delete messages.__\
        \n\n📌** CMD ➥** `.purgeto` reply\
        \n**USAGE   ➥  **__Will Mark that message as newest message of interval to delete messages and will delete all messages in that interval.__\
        \n\n📌** CMD ➥** `.purgeme` <count>\
        \n**USAGE   ➥  **__Deletes x(count) amount of your latest messages.__\
        \n\n📌** CMD ➥** `.del` <count> reply\
        \n**USAGE   ➥  **__Deletes the message you replied to in x(count) seconds if count is not used then deletes immediately.__"
    }
)
